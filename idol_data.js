...
(function() {
    ...
    // 存入偶像数据库
    topWin.IdolProjectData.idolDatabase = [
        {
            id: 1,
            name: "浅宫加爱",
            tag: "极具感染力的小太阳",
    ...
    // 存入台词数据
    topWin.IdolProjectData.bubbleTexts = {
        "浅宫加爱": {
    ...
    // 为了向下兼容旧 HTML 的写法，也把它们同步暴露给当前 window
    window.idolDatabase = topWin.IdolProjectData.idolDatabase;
    window.bubbleTexts = topWin.IdolProjectData.bubbleTexts;
