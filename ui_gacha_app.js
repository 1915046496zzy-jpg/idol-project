...
(function() {
    ...
    if (typeof topWin.playerCurrency === 'undefined') {
        topWin.playerCurrency = { stardust: 50000 }; // 测试用初始星尘
    }
            ...
            <div class="imas-container">
                ...
                <div class="imas-res-overlay" id="imas-res-overlay">
                    ...
                    <div class="imas-res-footer">
                        ...
                        <button class="imas-btn-again" id="btn-res-again"><i class="bi bi-arrow-repeat"></i> 再次十连</button>
                    </div>
                </div>
            </div>
        `;
